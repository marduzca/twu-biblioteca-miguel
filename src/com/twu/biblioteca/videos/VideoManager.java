...
public class VideoManager {
    ...
    public String showListOfVideos() {
        ...
        for(int i = 0; i < availableVideos.size(); i++) {
            videoListAsText.append((i+1) + ". " + availableVideos.get(i).getName() + " | " + availableVideos.get(i).getYear() + " | " + availableVideos.get(i).getDirector() + " | " + availableVideos.get(i).getMovieRating() + "/10\n");
